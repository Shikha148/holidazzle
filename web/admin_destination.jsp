...
<html>
    ...
    <h1 class="heading">
        ...
        <span>S</span>
            ...
            <form action="destination-form.jsp" method="post">
                <button type ="submit" name="des" value="addnew">
                    <a href="#" class="btn" >ADD NEW DESTINATION </a>
                </button>
            </form>
                                ...
                                %>
                                    <div class="box">
                                        ...
                                        <div class="content">
                                            ...
                                            <form action="update_destibnation.jsp" method="post">
                                            <button type ="submit" name="des_upt" value="<%=rs.getString("destination_id")%>">
                                            <a href="update_destibnation.jsp" class="btn" >Update </a>
                                            </button>
                                            </form>
                                            
                                            <form action="delete_destination.jsp" method="post">
                                            <button type ="submit" name="des_del" value="<%=rs.getString("destination_id")%>">
                                            <a href="delete_destination.jsp" class="btn" > Delete </a>
                                            </button>
                                            </form>
                                        </div>
                                    </div>
